...
import { ConnectionLost, IConnectionLost, IRouter, JupyterFrontEnd } from '@jupyterlab/application';
 ...
 */
function activateHubExtension(app, router, paths, palette, mainMenu) {
    ...
    const restartUrl = hubHost + URLExt.join(hubPrefix, `spawn?next=${hubPrefix}home`);
